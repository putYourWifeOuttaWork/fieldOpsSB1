/*
  # Enhance Clone Program Function

  1. Changes
    - Add support for custom phase number, type, and label in the clone_program function
    - Add validation to prevent duplicate phase number + type combinations
    - Improve phase creation logic when cloning programs
    
  2. Purpose
    - Enable dynamic phase creation during program cloning
    - Support proper program lineage tracking
    - Enforce business rules for phase numbering and types
*/
