/*
  # Schedule Daily Sessions Cron Job
  
  1. Changes
    - Installs pg_cron if not already installed
    - Schedules auto_create_daily_sessions to run daily at 00:01 (midnight)
    
  2. Purpose
    - Automates the session creation process to run once daily
    - Ensures all sites have a session available at the start of each day
*/
